<template>
  <div>
    <a-card :bordered="false" title="助手服务健康" :loading="loading">
...
import { assistantHealthApi } from '#/api';
...
async function fetchData() { loading.value = true; try { detail.value = await assistantHealthApi(); } finally { loading.value = false; } }
